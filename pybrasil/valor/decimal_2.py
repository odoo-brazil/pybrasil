...
#
# Esta é uma cópia exata da lib decimal padrão do Python 2.7
# como era no dia 12/06/2014 às 10h31
#
# Foi alterado o método from_float para converter floats a partir
# da representação em string, ao invés do valor binário real
#
# Foi alterada a função _convert_other para aceitar valores float
# por padrão, autoconvertendo a partir de uma string
#
...
def _convert_other(other, raiseit=False, allow_float=True):
    ...
    if isinstance(other, Decimal):
        return other
    if isinstance(other, DecimalOriginal):
